...
public enum ErrorCode {
    ...
    AGREEMENT_ALREADY_AGREED(HttpStatus.CONFLICT, "이미 서명한 세대입니다."),
    ...
    // comment_Report
    COMMENT_REPORT_ALREADY_EXISTS(HttpStatus.BAD_REQUEST, "이미 신고한 댓글입니다."),
    ...
    // replyReport
    REPLY_REPORT_ALREADY_EXISTS(HttpStatus.BAD_REQUEST, "이미 신고한 대댓글입니다.")
    ;
